...
rule satellite_finder:
	...
	shell:
		"""
		apptainer run -H ${{HOME}} docker://gempasteur/satellite_finder:0.9.1 --db-type gembase --models {params.model} --sequence-db {params.faa} -w {threads} -o {output.satellite_finder_outdir}
		"""
